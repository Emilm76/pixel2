import "@/app/(my-app)/globals.scss"
import { LenisScrollProvider } from "@/app/(my-app)/providers/lenis-provider"
import StoreProvider from "@/app/(my-app)/providers/store-provider"
