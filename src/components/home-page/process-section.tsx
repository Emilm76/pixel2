      ...
      <div className={clsx(styles.container, "container")}>
        ...
        <div className={styles.stepsWrapper}>
          ...
          <Step title="Веб-разработка" count="2">
            <ul className="list">
              <li>Создаём сайты и продающие посадочные страницы;</li>
              <li>Разрабатываем мобильные и веб-приложения;</li>
              <li>Разрабатываем фиды для агрегаторов объявлений;</li>
          ...
          <Step title="Оптимизация трафика" count="3">
            ...
            настраиваем SEO-оптимизацию сайтов
          </Step>
          <Step title="Лидогенерация" count="4">
            <ul className="list">
              <li>Запускаем медийную рекламу Programmatic;</li>
